        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <Car className="w-8 h-8 text-primary-400 mr-2" />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/register?role=rider" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">
                  Book a Ride
                </Link>
              </li>
              <li>
                <Link to="/register?role=driver" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">
                  Become a Driver
                </Link>
              </li>
              <li>
