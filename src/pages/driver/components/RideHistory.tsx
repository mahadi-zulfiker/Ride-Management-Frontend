...
import {
  ...
  DollarSign, Clock, ChevronLeft, ChevronRight, User
} from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md mb-6">
        <div className="p-6">
          ...
          <p className="text-gray-600">View your past rides and track your performance</p>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search rides by location or rider..."
                  value={searchTerm}
                ...
                <div key={ride.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mb-3">
                        ...
                        <div className="flex items-center">
                          <span className="font-medium text-gray-900 mr-2">{ride.rider}</span>
                          <div className="flex items-center">
                            <Star className="w-4 h-4 text-yellow-400 mr-1" />
                            <span className="text-sm text-gray-500">{ride.rating}</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="md:ml-6 mt-4 md:mt-0 text-right">
                      <div className="text-2xl font-bold text-primary-600">{formatCurrency(ride.fare)}</div>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">
                {formatCurrency(rideHistory.reduce((sum, ride) => sum + ride.fare, 0))}
              </p>
            </div>
          </div>
        </div>
